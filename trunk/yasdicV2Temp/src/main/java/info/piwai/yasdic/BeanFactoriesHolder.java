...
public class BeanFactoriesHolder {
	...
	public void register(String id, Integer scope, BeanFactory<?> factory) {
		...
		if (beanFactories.containsKey(id)) {
			throw new IllegalArgumentException("Cannot override a bean factory in the same holder.");
		}
	...
	public BeanFactoriesHolder contextInjector(ContextInjector<?> contextInjector) {
		this.contextInjector = contextInjector;
		return this;
	}

	public BeanFactoriesHolder onNewBeanListener(OnNewBeanListener onNewBeanListener) {
	...
	Set<String> getEagerSingletonIds() {
		return Collections.unmodifiableSet(eagerSingletonIds);
	}
	...
	boolean contains(String id) {
		return beanFactories.containsKey(id);
	}
